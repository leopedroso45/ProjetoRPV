...
$(".cadastrar-tarifa").click(function () {
    ...
    var id_trajeto = $("#categoria").attr("src");
    ...
    if ($("#data_inicio").val() === "" || $("#data_inicio").val() === null) {
       ...
       // alert("A data de fim não pode ser menor que a data de início da tarifa.");
        ...
        $.ajax({
            type: 'POST',
            url: baseUrl + 'tarifa-municipal/index',
            data: { id_trajeto: id_trajeto, iniciox: iniciox, fimx: fimx, valor: valor
            },
            async: false,
            success: function () {
                var dialog = bootbox.dialog({
                    ...
                    buttons: {
                        ok: {
                            ...
                            callback: function () {
                               window.location = baseUrl + 'tarifa-municipal';
                           }
                       }
                   }
               });
