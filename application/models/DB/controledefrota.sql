...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Mar-2019 às 21:38
...
INSERT INTO `categoria_onibus` (`id_categoria_onibus`, `descricao`, `taxa`) VALUES
(1, 'comum', '2,00'),
(2, 'leito', '2,50'),
(3, 'executivo', '3,00');
...
--
ALTER TABLE `onibus_viagem`
  MODIFY `id_onibus_viagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
